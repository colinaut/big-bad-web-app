...
export const eventsReducer = (state = {}, action) => {
    ...
    switch (action.type) {
        case actionTypes.GET_EVENTS_ALL_PUBLIC:
            return {...state, events: action.events, eventsById: action.eventsById, epochtimePublic: action.epochtime}
        case actionTypes.GET_EVENTS_ALL:
            return {...state, events: action.events, eventsById: action.eventsById, epochtimeAuth: action.epochtime}
